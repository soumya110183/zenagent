              ...
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-80" data-testid="popup-score-calculation">
                      <div className="space-y-3">
                        <h4 className="font-semibold text-sm">How Score is Calculated</h4>
                        ...
                        <div className="pt-2 border-t border-gray-200">
                          <p className="text-xs text-gray-500">
                            Score is generated by AI analysis combining these factors into a final rating from 0-100
                          </p>
                        </div>
                      </div>
                    </PopoverContent>
